 ...
 * ShedLock 설정.
 *
 * <p>분산 환경에서 스케줄 작업의 중복 실행을 방지하기 위한 Lock Provider 설정.
 *
 * <p>Redis를 백엔드로 사용하여 다음을 보장한다:
 *
 * <ul>
 *   <li>동일 작업은 한 인스턴스에서만 실행
 *   <li>lockAtMostFor: 작업 실패 시 자동 Lock 해제 (데드락 방지)
 *   <li>lockAtLeastFor: 최소 실행 간격 보장 (너무 빠른 재실행 방지)
 * </ul>
 */
@Configuration
@EnableScheduling
...
public class ShedLockConfig {
	 ...
	 *
	 * <p>Redis Key 형식: "shedlock:{taskName}"
	 *
